...
class HyperParams:
    ...
    reload_weight= "Reload weight"
    graph_type="Graph type"
    graph_node_num= "Graph node number"
    train_graph_num= "Train graph number"
    test_graph_num= "Test graph number"
    train_graph_refresh_portion= "Train graph refresh portion"
    train_graph_refresh_interval= "Train graph refresh interval"
