...
SMALLWORLD  = 0
SCALEFREE   = 1#barabasi
RANDOM      = 2
SCALE_SMALL	= 3#newman_watts_strogatz
RANDOM_G    = 4
MIX         = 5
...
class Graph_Generator():
	...
	def generate_set(self, mode):
		...
		for i in range(0, NUM_IT):
			...
			n, p, k, m, r, type = self.fetch_variables()
			...
			if type == RANDOM:
				...
				graph.generate_random_geometry_graph(n, r)
			else:
	...
	def fetch_variables(self):
		...
		r = float(np.random.randint(int(1000*MIN_R), int(1000*(MAX_R)))) / 1000.0
